    ...
    return (
      <div className="bottom_bar">
        ...
        <div className="bottom_bar-technology-logo-container">
          ...
          <span className="bottom_bar-technology-logo-item" onClick={()=> this.handleIdOfClickedLogo("CSS")}>
              <img alt="logo" src={require("../../images/tech_icons/css_icon.png")}/>
          </span>
          <span className="bottom_bar-technology-logo-item" onClick={()=> this.handleIdOfClickedLogo("React")}>
              <img alt="logo" src={require("../../images/tech_icons/react_icon.png")}/>
          </span>
        </div>
      </div>
    )
